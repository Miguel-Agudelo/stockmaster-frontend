        ...
        <div className="main-content">
            ...
            <div className="cat-tree-card">
                <div className="cat-tree-header">
                    ...
                    <div className="cat-tree-header__meta">
                        <small>
                ...
                {!isLoading && !error && paginatedTree.map(root => (
                    <React.Fragment key={root.id}>
                        ...
                        <div className="cat-row">
                            ...
                            <div className="cat-icon-box cat-icon-box--root">
                                <FontAwesomeIcon icon={faSitemap} className="cat-icon--root" />
                            </div>
                        ...
                        {expanded[root.id] && root.children.map(sub => (
                            <div className="cat-row cat-row-sub" key={sub.id}>
                                <div className="cat-sub-indent" />
                                <div className="cat-icon-box cat-icon-box--sub">
                                    <FontAwesomeIcon icon={faLayerGroup} className="cat-icon--sub" />
                                </div>
                                <div className="cat-info">
            ...
            {categoryToDelete && (
                <div className="modal-backdrop">
                    <div className="cat-delete-modal">
                        ...
                        {deleteError && (
                            <div className="cat-delete-error">{deleteError}</div>
                        )}
