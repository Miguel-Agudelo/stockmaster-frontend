...
// 1. Sacamos el estado inicial fuera del componente para que su referencia sea estática
const INITIAL_STATE = {
...
const ProductForm = ({ onSave, onCancel, currentProduct }) => {
    ...
    useEffect(() => {
        ...
        // Añadimos isEditing al arreglo. INITIAL_STATE al ser global ya no genera alertas.
