...
const StockMovementList = ({ userRole }) => {
    ...
    // mejora #3: sin strings literales
    const hasAccess = userRole === ROLES.ADMIN || userRole === ROLES.OPERATOR;
    ...
    if (!hasAccess) {
        return (
            <div className="main-content access-denied-wrapper">
    ...
    return (
        <div className="main-content">
            ...
            {/* Métricas — usa SummaryCard compartido (mejora #1) */}
